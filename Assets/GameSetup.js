...
function Start () {
    ...
    //bottomWall.size = new Vector2(mainCam.ScreenToWorldPoint (new Vector3 (Screen.width * 2f, 0f, 0f)).x, 1f);
    //bottomWall.transform = new Vector2(0f, mainCam.ScreenToWorldPoint (new Vector3 (0f, 0f, 0f)).y - 0.5f);
    ...
    //rw.position.x = 8f;//new Vector2(mainCam.ScreenToWorldPoint (new Vector3 (Screen.width, 0f, 0f)).x + 0.5f, 0f);
